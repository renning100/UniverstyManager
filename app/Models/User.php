...
use App\View\Components\Shared\Sidebar\Fairs;
 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|University[] $attendedUniversityEvents
...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    {
        return $this->belongsToMany(Fairs::class,FairStudentAttendance::class,'student_id','fair_id');
    }
    ...
    {
        return $this->belongsToMany(University::class,UniversityEventStudentAttendance::class,'student_id','university_id');
    }
}
